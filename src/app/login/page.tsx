...
export default function LoginPage() {
    return (
        <div className="min-h-screen bg-gray-50 relative flex items-center justify-center p-4 overflow-hidden">
            {/* Background Effects */}
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(245,179,1,0.15),transparent_40%)]" />
            <div className="absolute bottom-0 left-0 w-full h-[50vh] bg-gradient-to-t from-gray-100 to-transparent opacity-50" />
            ...
            <div className="container-custom max-w-5xl relative z-10">
                <div className="glass-card rounded-[2.5rem] overflow-hidden flex flex-col md:flex-row min-h-[600px] shadow-2xl animate-fade-in-up border border-white/40 bg-white/80">

                    {/* Left Side - Visual (Yellow Prominent) */}
                    <div className="w-full md:w-5/12 bg-accent relative p-10 text-neutral-dark flex flex-col justify-between overflow-hidden border-r border-black/5">
                        ...
                        <div className="relative z-10 flex items-center justify-between animate-fade-in delay-100">
                        ...
                        <div className="relative z-10 space-y-6 my-auto animate-slide-in-left delay-200">
                            <h2 className="font-heading font-bold text-5xl leading-[0.9] tracking-tight">
                                <span className="text-neutral-dark">Ignite</span> <br />
                                <span className="text-white drop-shadow-sm">Innovation.</span>
                            </h2>
                        ...
                        <div className="relative z-10 mt-auto pt-8 animate-fade-in delay-300">
                            <div className="flex items-center gap-3">
                                <div className="h-1 bg-black w-12 rounded-full" />
                                <span className="text-xs font-bold uppercase tracking-widest text-neutral-dark">Official Portal</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-full md:w-7/12 p-10 md:p-14 bg-white/60 backdrop-blur-md flex flex-col justify-center relative">
                        <div className="max-w-md mx-auto w-full space-y-8 animate-fade-in delay-200">
                            <div className="space-y-2">
                                <h3 className="font-heading text-3xl font-bold text-neutral-dark">Welcome Back</h3>
                                <p className="text-gray-500">Don't have an account? <Link href="/register" className="text-primary-600 font-bold hover:text-accent transition-colors">Sign up</Link></p>
                            </div>
                                    ...
                                    <div className="space-y-2 group">
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                type="email"
                                                id="email"
                                                className="w-full pl-12 pr-5 py-3.5 rounded-xl bg-white border border-gray-200 focus:border-accent focus:ring-4 focus:ring-accent/20 outline-none transition-all placeholder:text-gray-300 font-medium text-neutral-dark shadow-sm"
                            ...
                            <div className="relative py-2">
                                ...
                                <div className="relative flex justify-center text-xs uppercase">
                                    <span className="bg-white/80 backdrop-blur px-2 text-gray-500 font-bold">Or continue with</span>
                                </div>
                            </div>
