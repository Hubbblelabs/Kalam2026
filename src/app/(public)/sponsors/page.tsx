            ...
            <div className="container-custom">
                <div className="text-center mb-20 space-y-4">
                    <h1 className="font-heading font-bold text-5xl md:text-7xl text-neutral-dark animate-fade-in-up">
                        Our <span className="text-transparent bg-clip-text bg-linear-to-r from-secondary-500 to-accent-500">Sponsors</span>
                    </h1>
                ...
                <div className="space-y-20">
                    {sponsors.map((group, index) => (
                        ...
                        >
                            <h2 className="text-2xl font-bold text-secondary-500 mb-8 uppercase tracking-widest relative inline-block">
                                {group.tier}
                                <span className="absolute -bottom-2 left-1/2 -translate-x-1/2 w-12 h-1 bg-accent-500 rounded-full" />
                            </h2>
                            ...
                            <div className="flex flex-wrap justify-center gap-8 md:gap-12">
                                {group.companies.map((company, i) => (
                                    <div
                                        key={i}
                                        className={`glass-card p-8 rounded-2xl flex items-center justify-center hover:scale-105 transition-transform duration-300 ${index === 0 ? 'w-full max-w-md h-48 bg-linear-to-br from-secondary-500/5 to-accent-500/5' :
                ...
                <div className="mt-24 text-center p-12 bg-neutral-dark rounded-3xl text-white relative overflow-hidden animate-fade-in-up delay-500">
                    <div className="absolute inset-0 bg-[radial-gradient(var(--color-accent-500)_1px,transparent_1px)] bg-size-[24px_24px] opacity-10" />
                    <div className="relative z-10">
                        ...
                        <a
                            href="/contact"
                            className="inline-block px-8 py-4 bg-accent-500 text-neutral-dark font-bold rounded-full hover:bg-white transition-colors duration-300 shadow-lg"
                        >
                            Get in Touch
                        </a>
                    </div>
