  ...
  return (
    ...
    >
      <div className='relative lg:fixed bottom-0 h-auto lg:h-screen w-full'>
        <div className="h-full w-full bg-neutral-dark text-cream flex flex-col justify-between relative overflow-hidden">
          ...
          <div className="container-custom relative z-10 h-full flex flex-col justify-between pt-8 sm:pt-10 md:pt-12 lg:pt-6 pb-6 sm:pb-8 md:pb-10 lg:pb-4 px-4 sm:px-6 md:px-8">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start gap-8 sm:gap-10 md:gap-12 mb-10 sm:mb-12 md:mb-16 lg:mb-2">
              <div className="w-full lg:w-auto flex flex-col gap-8">
                ...
                <div>
                  <h3 className="text-accent-500 text-sm uppercase tracking-widest font-bold mb-6">Connect</h3>
                  <div className="flex gap-4">
                    {socialLinks.map((social, i) => (
                      <a
                        ...
                        className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center hover:bg-accent-500 hover:text-neutral-dark hover:scale-110 transition-all duration-300"
                      >
                ...
                <div>
                  <h3 className="text-accent-500 text-sm uppercase tracking-widest font-bold mb-4">Contact Us</h3>
                  <div className="flex flex-col gap-3 text-white/60 text-sm">
                    <a href="mailto:kalam@siet.ac.in" className="hover:text-white transition-colors flex items-center gap-3 group">
                      <div className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-accent-500 group-hover:text-neutral-dark transition-colors">
              ...
              <div className="w-full lg:w-auto flex flex-col md:flex-row gap-8 sm:gap-10 md:gap-12 lg:gap-24">
                <div className="grid grid-cols-2 gap-8 sm:gap-10 md:gap-12 lg:gap-24">
                  <div>
                    <h3 className="text-accent-500 text-sm uppercase tracking-widest font-bold mb-6">Explore</h3>
                  ...
                  <div>
                    <h3 className="text-accent-500 text-sm uppercase tracking-widest font-bold mb-6">Legal</h3>
                    <ul className="space-y-4 text-lg font-medium text-white/60">
                ...
                {/* Map Section */}
                <div>
                  <h3 className="text-accent-500 text-sm uppercase tracking-widest font-bold mb-4 sm:mb-6">Locate Us</h3>
            ...
            <div className="relative mt-6 sm:mt-8 md:mt-10 lg:mt-2">
              ...
              <div className="flex flex-col md:flex-row justify-between items-center md:items-end gap-4 sm:gap-6 md:gap-8">
                ...
                <div className="w-full md:w-auto text-center md:text-left">
                  <h1 className="font-heading font-black text-[18vw] sm:text-[16vw] md:text-[14vw] lg:text-[15vw] leading-[0.8] tracking-tighter text-transparent bg-clip-text bg-linear-to-b from-white to-white/50 select-none">
                    KALAM
                  </h1>
                  <div className="flex flex-col sm:flex-row items-center sm:items-center justify-between w-full pl-0 sm:pl-4 md:pl-8">
                    <div className="text-[7vw] sm:text-[6vw] md:text-[5vw] font-bold text-accent-500 tracking-tighter">2K26</div>
                ...
                <div className="w-full md:w-auto mb-2 sm:mb-4 md:mb-16 flex flex-col items-center gap-3 sm:gap-4 md:gap-6">
                  ...
                  {!isLoggedIn && (
                    <Link href="/register" className="group flex items-center gap-2 sm:gap-3 md:gap-4 text-sm sm:text-base md:text-lg lg:text-2xl font-bold bg-white text-neutral-dark py-2.5 px-4 sm:py-3 sm:px-5 md:py-3.5 md:px-6 lg:py-4 lg:px-8 rounded-full hover:bg-accent-500 transition-all duration-300 whitespace-nowrap">
                      Register Now
