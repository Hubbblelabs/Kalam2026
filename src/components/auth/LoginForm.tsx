                ...
                <div className="space-y-5">
                    <div className="space-y-2 group">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                required
                                className="w-full pl-12 pr-5 py-3.5 rounded-xl bg-gray-50 border border-gray-200 focus:border-accent-500 focus:ring-4 focus:ring-accent-500/20 outline-none transition-all placeholder:text-gray-300 font-medium text-neutral-dark shadow-sm"
                    ...
                    <div className="space-y-2 group">
                        <div className="flex justify-between items-center">
                            ...
                            <Link href="/forgot-password" className="text-xs text-primary-600 font-bold hover:text-accent-500 underline decoration-transparent hover:decoration-accent-500 transition-all">Forgot password?</Link>
                        </div>
                        <div className="relative">
                            <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-accent-500 transition-colors">
