...
export function SponsorMarquee() {
    ...
    return (
        <section className="py-10 bg-[#Fdfdf8] border-b border-black/5 overflow-hidden">
            <div className="container mx-auto px-6 mb-6">
                <p className="text-center text-sm font-semibold tracking-[0.2em] uppercase text-[#6B7B8C]">
            ...
            >
                {/* Gradient fade edges */}
                <div className="absolute left-0 top-0 bottom-0 w-32 bg-gradient-to-r from-[#Fdfdf8] to-transparent z-10 pointer-events-none" />
                <div className="absolute right-0 top-0 bottom-0 w-32 bg-gradient-to-l from-[#Fdfdf8] to-transparent z-10 pointer-events-none" />
                    ...
                    {[...sponsors, ...sponsors, ...sponsors].map((sponsor, index) => (
                        ...
                        >
                            ...
                            <div className="relative h-12 w-auto opacity-50 grayscale transition-all duration-300 group-hover:opacity-100 group-hover:grayscale-0 hover:scale-110">
                                ...
                                <span className="text-2xl font-black text-[#1C5D99] opacity-70 group-hover:opacity-100">{sponsor.name}</span>
                            </div>
                        </div>
                    ))}
                </div>
